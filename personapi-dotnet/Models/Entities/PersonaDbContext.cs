...
public partial class PersonaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            ...
            entity.HasOne(d => d.CcPerNavigation).WithMany()
                .HasForeignKey(d => d.CcPer)
                .HasConstraintName("FK__estudio__cc_per__3E52440B");

            entity.HasOne(d => d.IdProfNavigation).WithMany()
                .HasForeignKey(d => d.IdProf)
                .HasConstraintName("FK__estudio__id_prof__3D5E1FD2");
        });

        modelBuilder.Entity<Persona>(entity =>
        {
            entity.HasKey(e => e.Cc).HasName("PK__persona__3213666D825982B1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__profesio__3213E83FCC4981E3");
        ...
        {
            entity.HasKey(e => e.Num).HasName("PK__telefono__DF908D65AAF2E082");
            ...
            entity.HasOne(d => d.DuenioNavigation).WithMany(p => p.Telefonos)
                ...
                .HasConstraintName("FK__telefono__duenio__412EB0B6");
        });
